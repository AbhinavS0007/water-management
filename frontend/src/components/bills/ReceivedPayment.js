...
const ReceivedPayment = () => {
    ...
    // http://localhost:5002/api/bills/receivedPayment
    ...
    const fetchBills = async () => {
        try {
            ...
            const res = await api.get(
                `api/bills/receivedPayment?hourlyRate=${100}`
            );
                    ...
                    >
                        ...
                        <div className="p-6">
                            ...
                            <div className="mt-6 bg-gray-50 rounded-2xl p-5 border border-gray-100">
                                ...
                                <button
                                    className="mt-5 w-full bg-red-600  text-white font-semibold py-3 rounded-xl shadow-sm"
                                >
